                        ...
                        <div class="rounded-2xl border border-slate-200 p-5 transition hover:bg-slate-50 dark:border-zinc-800 dark:hover:bg-zinc-800/50 bg-white">
                            <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between bg-white dark:bg-zinc-900">
                                <div class="space-y-3">
                                    ...
                                    <div class="grid gap-2 text-sm text-slate-600 dark:text-zinc-400 sm:grid-cols-2 lg:grid-cols-3">
                                        <p>
                                        ...
                                        <p>
                                            <span class="font-medium text-slate-800 dark:text-zinc-200">Kualitas QC:</span>
                                            <span class="tabular-nums font-semibold text-slate-900 dark:text-white">{{ number_format($item->nilai_kualitas_kertas, 2, ',', '.') }}</span>
                                        </p>

                                        <p>
                                            <span class="font-medium text-slate-800 dark:text-zinc-200">Berat Bersih:</span>
                                            <span class="tabular-nums font-semibold text-slate-900 dark:text-white">{{ number_format($item->total_berat_bersih, 2, ',', '.') }} kg</span>
                                        </p>

                                        <p>
                                            <span class="font-medium text-slate-800 dark:text-zinc-200">Bobot Tidak Layak:</span>
                                            <span class="tabular-nums font-bold text-teal-600 dark:text-teal-400">{{ number_format($item->nilai_bobot_ketidaklayakan, 2, ',', '.') }}%</span>
                                        </p>

                                        <p>
                                            <span class="font-medium text-slate-800 dark:text-zinc-200">Berat Layak:</span>
                                            <span class="tabular-nums font-bold text-slate-900 dark:text-white">{{ number_format($item->berat_layak, 2, ',', '.') }} kg</span>
                                        </p>
                                    </div>
                                </div>
