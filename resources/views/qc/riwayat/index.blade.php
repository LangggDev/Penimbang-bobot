                            ...
                            <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                                <div class="space-y-3">
                                    ...
                                    <div class="grid gap-2 text-sm text-zinc-600 dark:text-zinc-400 sm:grid-cols-2">
                                        ...
                                        <p>
                                            <span class="font-medium text-zinc-800 dark:text-zinc-200">Nilai Kualitas:</span>
                                        ...
                                        <p>
                                            <span class="font-medium text-zinc-800 dark:text-zinc-200">Waktu QC:</span>
                                            {{ \Carbon\Carbon::parse($item->waktu_qc)->translatedFormat('d F Y, H:i') }}
                                        </p>

                                        <p class="sm:col-span-2">
                                            <span class="font-medium text-zinc-800 dark:text-zinc-200">Catatan:</span>
                                            {{ $item->catatan ?: '-' }}
                                        </p>
                                    </div>
                                </div>
